...
<html class="no-js">
	...
	<head>
		...
		<title>الفراهيدي - العروض نظريَّاً - البَحرُ البسيطُ</title>
		...
		<div id="main">
			...
			<div id="content">
	        	...
	        	<!-- featured -->
	        	<h1 class="home-block-heading">البَحرُ البَسيطُ</h1>
				...
				<div class="pageContentFixed lessonsMukhtar">
					...
					<div id="tabs">
						<ul>
							<li><a href="#tabs-1">البسيطُ التَّامُّ</a></li>
							<li><a href="#tabs-2">مُخَلَّعُ البسيطِ</a></li>
							<li><a href="#tabs-3">مَجزوءُ البسيطِ</a></li>
						</ul>
						<div id="tabs-1">
							...
							<table id="rule1" class="tableMukhtar3">
								...
								<tr>
									...
									<td>مُسْتَفْعِلُنْ <small class="showMeAll">جوازاتُها</small>
										<div class="maybeCome">
											مُسْتَفْعِلْ <br/>
											مُسْتَفْعِلَاْنْ <small class="goToMukhtar">3</small><br/>
										</div>
									</td>
								</tr>
							</table>
					...
					<div id="tabs2">
						...
						<div id="tabs2-1">
							<audio preload="preload" style="direction:ltr;" controls="controls" > 
								<source src="<?php echo base_url('assets/mp3'); ?>/b-24.mp3" type="audio/mp3" />
								...
								<object  type="application/x-shockwave-flash" <?php echo base_url('assets/mp3'); ?>/player.swf width="500" height="20"> <param name="movie" value="<?php echo base_url('assets/mp3'); ?>/player.swf" /> 
									...
									<param name="FlashVars" value="mp3=<?php echo base_url('assets/mp3'); ?>/b-24.mp3&amp;width=500&amp;volume=500&amp;showstop=1&amp;showvolume=1&amp;showloading=always&amp;bgcolor=C99E69"/>
						...
						<div id="tabs2-2">
							<audio preload="preload" style="direction:ltr;" controls="controls" > 
								<source src="<?php echo base_url('assets/mp3'); ?>/b-25.mp3" type="audio/mp3" />
								
								<object  type="application/x-shockwave-flash" <?php echo base_url('assets/mp3'); ?>/player.swf width="500" height="20"> <param name="movie" value="<?php echo base_url('assets/mp3'); ?>/player.swf" /> 
									<param name="bgcolor" value="#000000" />
									<param name="FlashVars" value="mp3=<?php echo base_url('assets/mp3'); ?>/b-25.mp3&amp;width=500&amp;volume=500&amp;showstop=1&amp;showvolume=1&amp;showloading=always&amp;bgcolor=C99E69"/>
									<p style="direction:rtl;">للأسف يبدو أن مستعرض الويب الذي تستخدمه حالياً لا يدعم تشغيل الملفّات الصوتيَّة , ننصحُكَ باستخدام نسخة حديثة من مستعرض Google Chrome أو مستعرض Mozilla Firefox<br/></p>
								</object>
					...
					<br/><br/>
					<a style="clear:both;margin-right:60px;" class="a-btn" href="<?php echo base_url('lessons/lesson3'); ?>">
					...
					<p id="hamesh3">3- في الشِّعر يلتقي السَّاكنان في قوافٍ مخصوصة كهذه الحالة!</p>
