...
<html class="no-js">
	...
	<head>
		...
		<title>الفراهيدي - العروض نظريَّاً - البَحرُ الخفيفُ</title>
		...
		<div id="main">
			...
			<div id="content">
	        	...
	        	<!-- featured -->
	        	<h1 class="home-block-heading">البَحرُ الخَفيفُ</h1>
				...
				<div class="pageContentFixed lessonsMukhtar">
					...
					<div id="tabs">
						<ul>
							<li><a href="#tabs-1">الخَفيفُ التَّامُّ</a></li>
							<li><a href="#tabs-2">مجزوءُ الخفيفِ</a></li>
						</ul>
						<div id="tabs-1">
					...
					<div id="tabs2">
						...
						<div id="tabs2-1">
							<audio preload="preload" style="direction:ltr;" controls="controls" > 
								<source src="<?php echo base_url('assets/mp3'); ?>/b-18.mp3" type="audio/mp3" />
								...
								<object  type="application/x-shockwave-flash" <?php echo base_url('assets/mp3'); ?>/player.swf width="500" height="20"> <param name="movie" value="<?php echo base_url('assets/mp3'); ?>/player.swf" /> 
									...
									<param name="FlashVars" value="mp3=<?php echo base_url('assets/mp3'); ?>/b-18.mp3&amp;width=500&amp;volume=500&amp;showstop=1&amp;showvolume=1&amp;showloading=always&amp;bgcolor=C99E69"/>
					...
					<br/><br/>
					<a style="clear:both;margin-right:60px;" class="a-btn" href="<?php echo base_url('lessons/lesson11'); ?>">
