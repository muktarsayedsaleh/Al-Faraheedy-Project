...
<html class="no-js">
	...
	<head>
		...
		<title>الفراهيدي - مشروع حوسبة عروض و قافية الشعر العربي على الويب - نتائج حالة تقطيع مشاركة عبر facebook</title>
		...
		<div id="main">
			...
			<div id="content">
	        	...
	        	<!-- featured -->
	        	<h1 class="home-block-heading">نتائج التقطيع الوزنيّ المشاركة عبر Facebook</h1>
